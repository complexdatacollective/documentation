...
prerequisites: >-
  ...
  - Read and understood the [project overview](/en/desktop/project-overview).
...
The **server status section** which initially shows nearby computers running Server that you may wish to [pair with](/en/desktop/key-concepts/pairing) and, once paired, shows the communication status of Interviewer with your paired Server.
...
This option uses our companion application, Server, to manage the distribution of interview protocols to field devices. The option to import from Server will appear in the protocols section once you have [paired your device](/en/desktop/key-concepts/pairing) with a computer running Server.
