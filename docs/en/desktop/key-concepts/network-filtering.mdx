...
<TipBox>
  ...
  the two sound similar in principle, they achieve very different design goals.
  Whereas network filtering determines which nodes to show _within_ a stage,
  skip logic determines if a stage should be shown at all. Consult the article
  on [skip logic](./skip-logic.md) to learn more.
</TipBox>
...
![Image](/documentation/assets/img/key-concepts/network-filtering/filtering-panel.png)
...
![Image](/documentation/assets/img/key-concepts/network-filtering/example.png)
...
![Image](/documentation/assets/img/key-concepts/network-filtering/side-panel.png)
