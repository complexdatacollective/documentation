...
image: /documentation/assets/img/interface-documentation/name-generators/large-roster.png
type: Name Generator
...
<KeyConcept title="Roster size constraints">
  ...
  study](../_how-to/choosing-hardware.md).
</KeyConcept>
...
![Image](/documentation/assets/img/interface-documentation/name-generators/architect-search.png)
