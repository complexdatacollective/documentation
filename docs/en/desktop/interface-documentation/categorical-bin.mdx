...
image: /documentation/assets/img/interface-documentation/categorical-bin/catbin-example.png
...
<StandAloneImage
  src="/documentation/assets/img/interface-documentation/categorical-bin/architect-other.png"
