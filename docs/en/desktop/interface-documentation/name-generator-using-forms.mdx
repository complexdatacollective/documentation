...
image: /documentation/assets/img/interface-documentation/name-generators/ng-form.png
type: Name Generator
...
good:
  ...
  - Ensure you collect a value for a variable called `name` on your form, so that [node labelling](../../reference/node-labelling) works correctly.
---
...
<StandAloneImage
  src="/documentation/assets/img/interface-documentation/name-generators/add-screen.png"
...
<TipBox>
  ...
  roster name generator](./small-roster-name-generator.md) or [large roster name
  generator](./large-roster-name-generator.md).
</TipBox>
...
![Image](/documentation/assets/img/interface-documentation/name-generators/preview.png)
...
<StandAloneImage
  src="/documentation/assets/img/interface-documentation/name-generators/side-panel.png"
