...
![Manage and Export Session](/documentation/assets/img/working-with-data/NC_DataExport0.png)
...
![Select Network Canvas Sessions for Export](/documentation/assets/img/working-with-data/NC_DataExport1.png)
...
![Confirm Network Canvas Export Options](/documentation/assets/img/working-with-data/NC_DataExport2.png)
...
![Select file location](/documentation/assets/img/working-with-data/NC_DataExport3.png)
...
<ImageFullWith
  src="/documentation/assets/img/working-with-data/vis1.png"
  name=""
/>
...
<ImageFullWith
  src="/documentation/assets/img/working-with-data/vis2.png"
  name=""
/>
...
<ImageFullWith
  src="/documentation/assets/img/working-with-data/vis4.png"
  name=""
/>
...
<ImageFullWith
  src="/documentation/assets/img/working-with-data/vis5.png"
  name=""
/>
```
