...
<ImageFullWith
  src="/documentation/assets/img/offline-data/online.png"
...
<ImageFullWith
  src="/documentation/assets/img/offline-data/offline.png"
...
<TipBox>
  Refer to the documentation from your operating system or device manufacturer (or simply test ahead of time) to ensure that the storage device you are using to transfer the protocol file can be read by the device running the Network Canvas Interviewer App _and_ the device running Architect.
</TipBox>
