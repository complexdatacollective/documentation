...
<ImageFullWith
  src="/documentation/assets/img/server-guide/server-welcome.png"
...
<StandAloneImage
  src="/documentation/assets/uploads/screen-shot-2021-04-29-at-4.55.48-pm.png"
...
<ImageFloatLeft
  name="Workspaces"
  src="/documentation/assets/uploads/screen-shot-2021-04-29-at-5.03.54-pm.png"
/>Your workspaces are shown in the purple column on the left hand side of the app, with a large plus button always visible that can be used to create a new workspace.
...
<StandAloneImage
  src="/documentation/assets/img/server-guide/imported-protocol-server.png"
...
<ImageFullWith
  src="/documentation/assets/img/server-guide/discovery-section.png"
  name="Image"
/>
...
<StandAloneImage
  src="/documentation/assets/img/key-concepts/pairing/nc-manual-pairing.png"
...
<StandAloneImage
  src="/documentation/assets/img/key-concepts/pairing/server-manual-details.png"
...
<StandAloneImage
  src="/documentation/assets/img/key-concepts/pairing/server-acknowledge.png"
...
<StandAloneImage
  src="/documentation/assets/img/server-guide/key-server.png"
...
<StandAloneImage
  src="/documentation/assets/img/server-guide/import-protocol-interviewer.png"
...
<StandAloneImage
  src="/documentation/assets/img/server-guide/export-data.png"
